...
describe('#leetspeak') do
  it('returns user string as is no leetspeak rules apply') do
    expect("happy".leetspeak).to(eq("happy"))
  end

  it('returns user string with replacing letter "e" with 3') do
    expect("elephant".leetspeak).to(eq("3l3phant"))
  end

  it('returns user string with replacing letter "e" with 3 and letter "o" with 0') do
  ...
  it('replaces character correctly with a string of words') do
